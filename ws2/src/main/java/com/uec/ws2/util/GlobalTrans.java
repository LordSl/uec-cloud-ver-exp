...
public class GlobalTrans {
    ...
    public static JSONObject secretJsonStrToJsonObject(String desKey, String secretJsonStr) throws Exception {
        Key key = GlobalTrans.getDesKeyFromHexString(desKey);
